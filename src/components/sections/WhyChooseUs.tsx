      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14">
          {reasons.map((r, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl p-8 border border-slate-100 hover:border-navy-200 hover:shadow-lg transition-all duration-300 group"
            >
              <div className="w-14 h-14 bg-navy-50 rounded-xl flex items-center justify-center text-2xl mb-5 group-hover:bg-navy-800 group-hover:scale-105 transition-all">
                <span className="group-hover:grayscale-0">{r.icon}</span>
              </div>
        ...
        {/* Founder card — RP Associates inspired */}
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            {/* Left — dark navy accent */}
