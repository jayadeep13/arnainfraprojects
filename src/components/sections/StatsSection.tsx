    ...
    <section id="stats" className="section-pad bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {stats.map((s, i) => (
            <div key={i} className="bg-white border border-slate-200 shadow-sm rounded-2xl p-7 text-center hover:shadow-md hover:border-orange-brand/30 transition-all group">
